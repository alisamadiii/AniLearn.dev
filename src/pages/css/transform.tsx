          ...
          <LiveChanges className="flex flex-wrap gap-8">
            <div className="basis-80 grow">
              <CodeBlocks
                ...
                wrapLongLines={true}
              />
              <div className="relative flex items-center justify-center flex-grow p-4 overflow-hidden border rounded-lg h-52 bg-box border-white-low-opacity before:content-['Without-Perspective'] before:bg-red-800 before:text-font-clr-1 before:px-2 before:py-1 before:rounded before:absolute before:top-0 before:left-0 before:text-xs">
                <Image
                  src={image || IMAGE}
                  width={400}
                  height={400}
            ...
            <div className="grow basis-80">
              <CodeBlocks
                ...
                wrapLongLines={true}
              />
              <div className="relative flex items-center justify-center p-4 overflow-hidden border rounded-lg h-52 bg-box border-white-low-opacity before:content-['Perspective'] before:bg-green-800 before:text-font-clr-1 before:px-2 before:py-1 before:rounded before:absolute before:top-0 before:left-0 before:text-xs">
                <Image
                  src={image || IMAGE}
                  width={400}
                  height={400}
