...
const buttonVariants = cva("", {
  variants: {
    variant: {
      ...
      footer: "px-3 py-2 rounded-md hover:bg-gray-200 dark:hover:bg-button-d",
      workplace:
        "relative text-sm md:text-base px-4 py-2 rounded-lg bg-button dark:bg-button-d after:content after:w-full after:h-full after:bg-gradient-to-r after:from-primary after:to-secondary after:absolute after:inset-0 after:-z-10 after:opacity-0 after:duration-200 overflow-hidden duration-200 isolate"
    }
  },
  defaultVariants: {
    variant: "navbar"
