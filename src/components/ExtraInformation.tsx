...
export default function ExtraInformation({}: Props) {
  return (
    <Container className="pt-8 border-t-2 border-white-low-opacity">
      <h2 className="mb-1 text-3xl font-bold text-black">Contact Us</h2>
      ...
      <div className="flex flex-wrap gap-4">
        <a
          ...
          <h3 className="mt-2 text-xl text-font-clr">Email</h3>
        ...
        <a
          ...
          <h3 className="mt-2 text-xl text-font-clr">Twitter</h3>
          <p>@Ali_Developer05</p>
        </a>
        <a
          ...
          <h3 className="mt-2 text-xl text-font-clr">LinkedIn</h3>
          <p>@Ali Reza</p>
        </a>
      </div>
    </Container>
