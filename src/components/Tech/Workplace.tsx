...
export default function Workplace({ children, className }: Props) {
  return (
    <div className="mt-4 mb-12">
      <h1 className="flex gap-2 pb-2 mt-12 text-3xl font-semibold capitalize border-b-2 text-heading group border-white-low-opacity dark:border-white-low-opacity-d">
